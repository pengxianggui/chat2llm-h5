<template>
    <div class="param-config">
        <el-button class="setting" :icon="ChatLineRound" circle size="large" @click="visible = true"></el-button>
        ...
        <el-drawer v-model="visible" direction="rtl" size="60%" class="session-drawer" :append-to-body="false"
            ...
            <el-form :model="chatParam">
                ...
                <el-form-item prop="top_k" label="匹配知识条数">
                    <el-slider v-model="chatParam.top_k" :min="1" :max="10" :step="1" />
                </el-form-item>
                <el-form-item prop="score_threshold" label="知识匹配分数阈值">
...
import { useChatParams } from "@/stores/chatParams.ts";
import { ChatMode } from "@/views/chat2llm/model";

const store = useChatParams();
const chatParam = store.get();
